...
* **Voluntary Information:** Name, email address, and phone number provided via our contact forms or AI Chatbots.
* **Automated Tracking:** We use Google Analytics and cookies to collect aggregate data (IP addresses, browser type, and site behavior) to improve our AI models and user experience.
...
We use your data to:
* Deliver and optimize AI automations and Schema implementations.
* Communicate via email or SMS regarding your inquiries.
* Perform internal marketing and lead scoring via our CRM.
